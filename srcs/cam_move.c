...
/*   Updated: 2018/06/22 13:08:16 by Pringles         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (sign == '+')
		cam->origin = vector_op(cam->origin, lambda_product_d3(move, adjust_direction(
					new_vector_3d(0, 0, 1), cam->rot)), '+');
	else if (sign == '-')
		cam->origin = vector_op(cam->origin, lambda_product_d3(-move, adjust_direction(
					new_vector_3d(0, 0, 1), cam->rot)), '+');
}
