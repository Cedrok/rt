...
t_bloc			*create_bloc_filter(int w, int h)
{
	...
	bc->lst_obj[7] = new_obj(r.btn_sc1, sizeof(r.btn_sc1), BUTTON);
	bc->lst_obj[8] = new_obj(r.btn_sc2, sizeof(r.btn_sc2), BUTTON);
	bc->lst_obj[9] = new_obj(r.btn_sc3, sizeof(r.btn_sc3), BUTTON);
	return (bc);
}
